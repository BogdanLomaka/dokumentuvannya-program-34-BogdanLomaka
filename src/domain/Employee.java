...
public class Employee {
   ...
   // private static int employeesCount = 0;
    ...
    /**
     * конструктор для об'єкта класу ""Employee""
     */
    public Employee() {
...
//        }
    ...
    /**
     * метод setJobTitle() привласнює значення змінної ""jobTitle ""
     * @param job 
     */
    ...
    /**
     * метод setDept() привласнює значення змінної ""dept""
     * @param dept 
     */
    ...
    /**
     * метод setName() привласнює значення змінної ""name""
     * @param name 
     */
